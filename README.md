# Sequent Microsystems RTD Data Acquisition Home Assistant Integration

Integrate [RTD Data Acquisition](https://sequentmicrosystems.com/products/rtd-data-acquisition-card-for-rpi)
...
- [video]() for steps 4. and 5. (replace SMioplus-ha with SMrtd-ha)
...
5. Add SMrtd config in configuration.yaml
    ...
    - At the end of the file append the SMrtd config:
        ```yaml
        SMrtd:
        ```
